--[[ 
    FILE: fishing_ManHub_v3.1.lua (MOD Auto Favorite v1.0)
...
local GUI_NAMES = {
    Main = "ManHub_Fishing_UI",
    Mobile = "ManHub_Mobile_Button",
    Coords = "ManHub_Coords_HUD"
}
...
for _, v in pairs(CoreGui:GetDescendants()) do
    if v:IsA("TextLabel") and v.Text == "Maman" then
